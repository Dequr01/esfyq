...
const navLinks = [
  ...
  { id: 'contact', label: 'THE CONNECTION', chapter: 'III' },
]
...
export default function Navigation() {
  ...
  const { isDark, toggleTheme, toggleCarLights, carLightsOn } = useTheme()
  ...
  return (
    ...
    >
      ...
      {/* ── Lights toggle (Hidden) ── */}
      {/* 
      <button
        onClick={toggleCarLights}
        style={{
          marginLeft: 'auto',
          flexShrink: 0,
          background: 'none',
          border: 'none',
          cursor: 'pointer',
          color: carLightsOn ? 'var(--accent, #facc15)' : 'var(--text)',
          display: 'flex',
          alignItems: 'center',
